...
func New(ctx context.Context, cfg config.Config) (*App, error) {
	...
	enterprises := httpapi.NewEnterprises(store, documentCache)
	...
	imageGenerationJobs := httpapi.NewImageGenerationJobs(store, documentCache)
	...
	mux.Handle("/v1/enterprises/", enterprises)
	...
	mux.Handle("/v1/image-generation-jobs", imageGenerationJobs)
