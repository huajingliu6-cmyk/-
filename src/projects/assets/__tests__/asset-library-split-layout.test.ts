...
describe("asset library three-pane workspace contracts", () => {
  ...
  it("scene and prop reuse character-like prompt split without voice", () => {
    ...
    expect(sceneDetail).toContain("onGenerationProgress=");
    expect(propDetail).toContain("onGenerationProgress=");
    expect(sceneDetail).toContain("DesignGenerationOverlay");
    expect(propDetail).toContain("DesignGenerationOverlay");
    expect(sceneDetail).toContain("promptScopeMedia=");
    expect(propDetail).toContain("promptScopeMedia=");
    expect(sceneDetail).toContain("await onPersist(labeled)");
    expect(propDetail).toContain("await onPersist(labeled)");
    ...
    expect(sceneDetail).toContain("selectMainSlot");
    expect(propDetail).toContain("selectMainSlot");
    expect(sceneDetail).toContain("emptyUnusedEdit");
    expect(propDetail).toContain("emptyUnusedEdit");
    expect(sceneDetail).toContain("点击此处可返回主图");
    expect(propDetail).toContain("点击此处可返回主图");
    expect(sceneDetail).toContain("scene-empty-edit-hero");
    expect(propDetail).toContain("prop-empty-edit-hero");
    expect(sceneDetail).toContain("onSelectMain={selectMainSlot}");
    expect(propDetail).toContain("onSelectMain={selectMainSlot}");
    ...
    expect(sceneDetail).toContain("await onPersist(next)");
    expect(propDetail).toContain("await onPersist(next)");
    expect(scene).toContain("nextScene");
    expect(prop).toContain("nextProp");
    expect(css).toContain("character-look-card--editing");
    expect(css).toContain("character-look-delete-dialog__panel");
